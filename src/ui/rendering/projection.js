...
export const SPHERE_VIEW = Object.freeze({
  ...
  canopyStride: 1,
  // Fountain portals are small, but globe pick volumes still need room.
  // Flat mode uses PORTAL_MARKERS.minSeparationCells; the planet uses
  // this slightly larger floor so neighbouring links stay separately
  // clickable from orbit.
  portalMinSeparationCells: 7,
  portalSpreadIterations: 14,
